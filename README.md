...
Embedded Weather Quest – IoT weather application using API integration and LCD display.

Bluetooth Controlled Robot Car – Real-time wireless control using UART and HC-05 module.

Traffic Light Controller – Finite state machine design for multi-direction control logic.

Serial Terminal Calculator – 8051-based serial interface calculator for number system operations.
...
Tools: Keil µVision, Jira, Confluence, Git, VS Code
